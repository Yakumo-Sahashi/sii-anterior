...
<div class="container">
    <div class="row justify-content-around py-5">
        <div class="col-md-12 text-center">
            <div class="container">
                <div class="row">
                    <h2 class="mb-4">NUMEROS DE CONTROL SOLICITADOS</h2>
                    <hr>
...
<script src="<?=CONTROLLER?>/acad/controller_aprobar_ctrl.js"></script>
<script src="<?= CONTROLLER ?>/acad/controller_tabla_solicitud.js"></script>
